...
class MadinahAccomodationController extends Controller
{
    /**
    ...
    {
        $accomodations = Accomodation::where('accomodation_type', 'MADINAH')->get();
        return view('admin.madinah-accomodation.index', compact('accomodations'));
    }
    ...
    {
        return view('admin.madinah-accomodation.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        $accomodation->accomodation_type = "MADINAH";
        ...
        return redirect()->route('madinah-accomodations.index')->with($notification);
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.madinah-accomodation.edit', compact('accomodation'));
    }
