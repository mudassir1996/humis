...
class MakkahAccomodationController extends Controller
{
    /**
    ...
    {
        $accomodations = Accomodation::where('accomodation_type', 'MAKKAH')->get();
        return view('admin.makkah-accomodation.index', compact('accomodations'));
    }
    ...
    {
        return view('admin.makkah-accomodation.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        $accomodation->accomodation_type = "MAKKAH";
        ...
        return redirect()->route('makkah-accomodations.index')->with($notification);
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.makkah-accomodation.edit', compact('accomodation'));
    }
