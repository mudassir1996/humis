...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('applications', function (Blueprint $table) {
            ...
            $table->string("attachment_passport")->default("");
            $table->string("attachment_cnic")->default("");
            $table->string("attachment_picture")->default("");
            $table->string("attachment_medical")->default("");
            $table->string("attachment_other")->default("");
