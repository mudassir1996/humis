            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between py-3">
                        <h3>Addition Facilities List</h3>
                        ...
                        <a href="{{ route('additional-facilities.create') }}">
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu border rounded"
                                                    ...
                                                    <a class="dropdown-item d-flex align-items-center p-2"
                                                        href="{{ route('additional-facilities.edit', $additional_facility->id) }}"><i
                                                            data-feather="edit-2" class="icon-md mr-2"></i> <span
                                                            class="">Edit</span></a>
                                                    <form action="{{ route('additional-facilities.destroy', $additional_facility->id) }}"
                                                        id="delete_item_from{{ $additional_facility->id }}" method="post">
                                                        @csrf
                                                        @method('DELETE')
                                                        <a type="button" class="dropdown-item d-flex align-items-center p-2"
                                                            title="Delete"
                                                            onclick="deleteConfirmation('delete_item_from{{ $additional_facility->id }}')"><i
