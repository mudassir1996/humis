                            ...
                            <tbody>
                                @foreach ($airports as $airport)
                                    <tr>
                                        ...
                                        <td>{{ $airport->airport_country_code }}</td>
