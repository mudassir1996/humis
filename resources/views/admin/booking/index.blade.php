            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex justify-content-between py-3">
                        <h3>Edit Booking</h3>
                        <button type="button" class="btn btn-primary" data-toggle="modal"filter data-target="#filterModal">
                            ...
                            <tbody>
                                @foreach ($bookings as $booking)
                                    <tr>
                                        ...
                                        <td>{{ $booking->package_type == 'CUSTOM' ? $booking->custom_package_name : $booking->package_name }}
                                        </td>
                                        <td>
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu border rounded"
                                                    ...
                                                    <a class="dropdown-item d-flex align-items-center p-2"
                                                        href="{{ route('view-booking-details', $booking->id) }}"><i
                                                            data-feather="eye" class="icon-md mr-2"></i> <span
                                                            class="">View Detail</span></a>
                                                    <a class="dropdown-item d-flex align-items-center p-2"
                                                        href="{{ route('reciepts.create', ['booking_id' => $booking->id]) }}"><i
