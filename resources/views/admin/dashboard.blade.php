...
@section('content')
      <div class="d-flex justify-content-between align-items-center flex-wrap grid-margin">
                    <div>
                        <h4 class="mb-3 mb-md-0">Welcome to {{ucfirst(strtolower(auth()->user()->role))}} Dashboard</h4>
                    </div>
                    ...
                    <div class="col-lg-7 col-xl-8 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <p class="text-muted mb-4">Sales are activities related to selling or the number of goods
