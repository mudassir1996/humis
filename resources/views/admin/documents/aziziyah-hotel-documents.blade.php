...
@section('content')
    <div class="row justify-content-center" id="reciept-voucher">
        <div class="col-lg-10">
            <div class="card">
                <div class="card-body">
                    <form action="{{route('aziziyah-hotel-documents-store')}}" method="post" enctype="multipart/form-data">
                        @csrf
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <select class="select2-single" id="accomodation_id" name="accomodation_id">
                                        <option></option>
                                        @foreach ($aziziyah_accommodations as $aziziyah_accommodation)
                                                <option value="{{ $aziziyah_accommodation->id }}">
                                                    {{ $aziziyah_accommodation->hotel_name }}</option>
                                            @endforeach
                                    </select>
                                </div>
                            </div>
