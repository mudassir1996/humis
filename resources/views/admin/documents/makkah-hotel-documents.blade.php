...
@section('content')
    <div class="row justify-content-center" id="reciept-voucher">
        <div class="col-lg-10">
            <div class="card">
                <div class="card-body">
                    <form action="{{route('makkah-hotel-documents-store')}}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="row mb-5 justify-content-center align-items-center">
                            <div class="col-lg-12 text-center">
                                <h4>Makkah Hotel Document/Agreement</h4>
                            </div>
                            {{-- <div class="col-lg-12 text-center">
                                <p>Payment Voucher</p>
                            </div> --}}
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <select class="select2-single" id="accomodation_id" name="accomodation_id">
                                        <option></option>
                                        @foreach ($makkah_accommodations as $makkah_accommodation)
                                                <option value="{{ $makkah_accommodation->id }}">
                                                    {{ $makkah_accommodation->hotel_name }}</option>
                                            @endforeach
                                    </select>
                                </div>
                            </div>
