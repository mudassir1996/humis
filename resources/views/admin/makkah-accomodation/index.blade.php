            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between py-3">
                        <h3>Makkah Accomodation List</h3>
                        ...
                        <a href="{{ route('makkah-accomodations.create') }}">
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu border rounded"
                                                    ...
                                                    <a class="dropdown-item d-flex align-items-center p-2"
                                                        href="{{ route('makkah-accomodations.edit', $accomodation->id) }}"><i
                                                            data-feather="edit-2" class="icon-md mr-2"></i> <span
                                                            class="">Edit</span></a>
                                                    <form action="{{ route('makkah-accomodations.destroy', $accomodation->id) }}"
