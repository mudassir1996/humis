...
@section('content')
    ...
    <div class="row justify-content-center">
        <div class="col-lg-10">
            <div class="card">
                <div class="card-body">
                    <form class="step-2" method="post" id="other-cost-form" action="{{ route('other-costs.update',$other_cost->id) }}">
                        @csrf
                        @method('PATCH')
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <label class="control-label">Qurbani Cost Title <span class="text-danger">*</span></label>
