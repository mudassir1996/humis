...
@section('content')
    ...
    <div class="row justify-content-center">
        <div class="col-lg-10">
            <div class="card">
                <div class="card-body">
                    <form class="step-2" id="bookingStep2" action="{{route('packages.store')}}" method="POST">
                        @csrf
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" placeholder="Enter package name" name="package_name" 
                                            type="text">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <select class="select2-single" name="qurbani_cost_id"
                                            id="qurbani_cost_id">
                                            <option></option>
