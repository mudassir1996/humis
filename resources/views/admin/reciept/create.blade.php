...
@section('content')
    <div class="row justify-content-center" id="reciept-voucher">
        <div class="col-lg-10">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('reciepts.store') }}" id="reciept-form" method="post">
                        @csrf
                        ...
                        <div class="form-group row align-items-center justify-content-between">
                            <label for="booking_number" class="col-sm-7 col-4">Booking No.</label>
                            <div class="col-sm-5 col-8">
                                <input type="number" readonly class="form-control" id="booking_number"
                                    value="{{ $booking->booking_number }}">
                                <input type="hidden" name="booking_id" value="{{ $booking_id }}">
                            </div>
                        </div>
                        <div class="form-group row align-items-center justify-content-between">
                            <label for="reciept_number" class="col-sm-7 col-4">Reciept No.</label>
                            <div class="col-sm-5 col-8">
                                <input type="number" readonly class="form-control" name="reciept_number"
                                    id="reciept_number" value="{{ time() }}">
                            </div>
                        </div>
                        <div class="form-group row align-items-center justify-content-between">
                            <label for="datePickerIssueDate" class="col-sm-7 col-4">Date <span
                                    class="text-danger">*</span></label>
                            <div class="col-sm-5 col-8">
                                <div class="input-group date datepicker" id="datePickerIssueDate">
                                    <input type="text" name="reciept_date" class="form-control"
                                        placeholder="Enter Date"><span class="input-group-addon"><i
                                            data-feather="calendar"></i></span>
                                </div>
                            </div>
                        </div>
                        <div class="form-group row align-items-center justify-content-between">
                            <label for="contact_name" class="col-sm-7 col-4">Contact Name</label>
                            <div class="col-sm-5 col-8">
                                <input type="text" class="form-control" readonly id="contact_name"
                        ...
                        <div class="row pb-4 justify-content-center">
                            <div class="col-md-12">
                                ...
                                <div class="form-group row align-items-center justify-content-between">
                                    <label for="payment_mode" class="col-sm-7 col-4">
                                        Payment Mode <span class="text-danger">*</span>
                                    </label>
                                    <div class="col-sm-5 col-8">
                                        <select class="select2-single" id="payment_mode" name="payment_mode">
                                            <option></option>
                                ...
                                <div class="form-group row align-items-center justify-content-between"
                                    id="bank_account_field">
                                    <label for="exampleInputUsername2" class="col-sm-7 col-4">Bank Account <span
                                            class="text-danger">*</span></label>
                                    <div class="col-sm-5 col-8">
                                ...
                                <div class="form-group row align-items-center justify-content-between" id="cheque_field">
                                    <label for="exampleInputUsername2" class="col-sm-7 col-4">Check No. <span
                                            class="text-danger">*</span></label>
                                    <div class="col-sm-5 col-8">
                                ...
                                <div class="form-group row align-items-center justify-content-between">
                                    <label for="exampleInputUsername2" class="col-sm-7 col-4">Amount <span
                                            class="text-danger">*</span></label>
                                    <div class="col-sm-5 col-8">
                                ...
                                <h5 class="pb-4">Amount In words: <span id="amount_in_words_txt"
                                ...
                                <div class="form-group row align-items-center justify-content-between">
                                    ...
                                    <div class="col-sm-5 col-8">
                                        <input type="number" name="transaction_charges" class="form-control"
                                            id="transaction_charges" placeholder="Enter Trasaction Charges">
                                    </div>
                                </div>
                                <div class="form-group row align-items-center justify-content-between">
                                    <label for="exampleInputUsername2" class="col-sm-7 col-4">Balance Amount</label>
                                    <div class="col-sm-5 col-8 text-right">
                                        <h6>{{ $booking->currency }} <span
                                                id="balance_amount">{{ $balance_amount }}</span></h6>
                                ...
                                <div class="form-group row align-items-center justify-content-between">
                                    <label for="exampleInputUsername2" class="col-sm-7 col-4">Recieving Officer <span
                                            class="text-danger">*</span></label>
                                    <div class="col-sm-5 col-8 ">
...
@section('scripts')
    ...
    <script>
        ...
        $('#amount').on('keyup', function() {
            let amount = $(this).val();
            let total_bill = parseInt("{{ $balance_amount }}");
            if (amount == '') {
                $("#amount_in_words_txt").text("");
                $("#amount_in_words").val("");
                $("#balance_amount").text(total_bill);
            } else if (amount < 1) {
                ...
                if (amount <= total_bill) {
                    $("#amount_in_words_txt").text(toWords(amount));
                    $("#amount_in_words").val(toWords(amount));
