            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between py-3">
                        ...
                        <a href="{{ route('special-transports.create') }}">
                    ...
                    <div class="table-responsive">
                        <table id="dataTableExample" class="table">
                            ...
                            <tbody>
                                @foreach ($special_transports as $special_transport)
                                    <tr>
                                        <td>{{ $special_transport->id }}</td>
                                        <td>{{ $special_transport->maktab_name }}</td>
                                        <td>{{ $special_transport->transport_cost }}</td>
                                        <td>
...
<div class="dropdown">
                                                ...
                                                <div class="dropdown-menu border rounded"
                                                    ...
                                                    <a class="dropdown-item d-flex align-items-center p-2" href="{{ route('special-transports.edit', $special_transport->id) }}"><i
                                                            data-feather="edit-2" class="icon-md mr-2"></i> <span
                                                            class="">Edit</span></a>
                                                            <form action="{{ route('special-transports.destroy', $special_transport->id) }}"
                                                        id="delete_item_from{{ $special_transport->id }}" method="post">
                                                        @csrf
                                                        @method('DELETE')
                                                        <a type="button" class="dropdown-item d-flex align-items-center p-2"
                                                            title="Delete"
                                                            onclick="deleteConfirmation('delete_item_from{{ $special_transport->id }}')"><i
